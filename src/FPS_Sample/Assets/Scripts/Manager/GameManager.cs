...
namespace SimpleFramework.Manager {
    public class GameManager : LuaBehaviour {
        ...
        /// <summary>
        /// 1.将包资源目录（streamAssets）下的files.txt复制到 数据目录 下
        /// 2.将包资源目录下files.txt中所有的文件 复制到 数据目录下对应的位置
        /// 3.启动更新资源StartCoroutine(OnUpdateResource());
        /// </summary>
        /// <returns></returns>
        IEnumerator OnExtractResource() {
            ...
            NotificationCenter.Instance.SendNotification(NotiConst.UPDATE_MESSAGE, message);
